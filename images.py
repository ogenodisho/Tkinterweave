...
PENCIL = None
SPRAY_CAN = None
MAGNIFYING_GLASS = None

# call this before the mainloop because
# the photoimages cannot be created instantly
def initialize():
    global CALLIGRAPHY_LEFT, CALLIGRAPHY_RIGHT, PENCIL, SPRAY_CAN, MAGNIFYING_GLASS
    ...
    MAGNIFYING_GLASS = PhotoImage(file="images/magnifying_glass.gif")
